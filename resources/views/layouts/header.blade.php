<!-- pageheader
================================================== -->
<section class="s-pageheader @if(request()->routeIs('index')) s-pageheader--home @endif">
                    ...
                    <li class="has-children">
                        ...
                        <ul class="sub-menu">
                            @foreach($categories as $category)
                                <li><a href="{{ route('show_category', ['categoryId' => $category->id]) }}">{{ $category->name }}</a></li>
                            @endforeach
                        </ul>
                    </li>
                    <li class="has-children">
    ...
    @if(request()->routeIs('index')) @include('layouts.headerContent') @endif
